...
class ExpenseCategory extends $pb.ProtobufEnum {
  static const ExpenseCategory FOOD = ExpenseCategory._(0, _omitEnumNames ? '' : 'FOOD');
  static const ExpenseCategory TRAVEL = ExpenseCategory._(1, _omitEnumNames ? '' : 'TRAVEL');
  static const ExpenseCategory SHOPPING = ExpenseCategory._(2, _omitEnumNames ? '' : 'SHOPPING');
